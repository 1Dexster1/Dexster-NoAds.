...
- `x86_64`: Emulators / specific devices
- `universal`: Works on all devices (larger file)
...
- `arm64-v8a`: أغلب الأجهزة الحديثة
- `armeabi-v7a`: الأجهزة القديمة 32-bit
- `x86_64`: المحاكيات وبعض الأجهزة
- `universal`: يعمل على كل الأجهزة (حجمه أكبر)
